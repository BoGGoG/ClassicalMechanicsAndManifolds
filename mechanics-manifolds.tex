...
\begin{defn}[diffeomorphic]
    ...
    is in $C^\infty$ in the $\mathcal{R}^d$-sense, see figure~\ref{fig:diffeo-commdiag}.
...
\begin{figure}[tbh]
    ...
    \end{tikzpicture}
    \caption{Picture for the definition of diffeomorphisms}
...
\begin{note}
    ...
    choice of charts, see figure~\ref{fig:diffeo-commdiag}.
\end{note}
%------------------------------------------------
